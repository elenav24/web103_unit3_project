# WEB103 Project 3 - *Berry Bitty City*

Submitted by: **Elena Marquez**

About this web app: **a virtual community space (Berry Bitty City) with an interactive interface that allows users to explore events by location.**
...
- Many challenges with making the svg/image map and the buttons. 
